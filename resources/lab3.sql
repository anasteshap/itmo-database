...
SELECT tAvalue, tBvalue FROM dbo.tA right JOIN dbo.tB ON
        tA.tAvalue = tB.tBvalue

SELECT tAvalue, tBvalue FROM dbo.tA cross JOIN dbo.tB
...
INSERT INTO dbo.tA (tAvalue) VALUES (0)
INSERT INTO dbo.tA (tAvalue) VALUES (1)
INSERT INTO dbo.tA (tAvalue) VALUES (2)
INSERT INTO dbo.tA (tAvalue) VALUES (3)
INSERT INTO dbo.tA (tAvalue) VALUES (null)

UPDATE dbo.tB SET priority=IF(priority=1, 2, 1) WHERE priority IN (1,2)
